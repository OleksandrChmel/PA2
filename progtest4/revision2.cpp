...
public:
    ...
    void vcopy ( const c_vector<T> & other );
    ...
    void data(const T * _pointer){ m_Data = _pointer; }
...
template < class T >
void c_vector<T>::vcopy ( const c_vector<T> & other )
{
    m_Data = new T [ other.m_LastIndex ];
    m_Size = other.m_Size;
...
template < class T >
c_vector<T>& c_vector<T>::operator= ( const c_vector<T> & other )
{
...
public:
    ...
    const c_vector<Client> & getClients()const{ return g_Clients; }
